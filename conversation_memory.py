...
logger = logging.getLogger("axelr.conversation_memory")
...
# ---------------------------------------------------------------------------
# Inline Cloudflare Vectorize client (kept local so this module is
# self-contained — no cross-module imports inside ``core``).
# ---------------------------------------------------------------------------
