...
try:
    ...
    raise ImportError("torch is not installed. Install it with: pip install torch transformers")
try:
    from transformers import AutoModelForCausalLM, AutoTokenizer
except Exception:
    raise ImportError("transformers is not installed or could not be imported. Install it with: pip install transformers")
